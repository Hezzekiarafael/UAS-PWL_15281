...
// code getCost yang diadaptasi dari hasil simulasi pada kedua endpoint Raja Ongkir menggunakan postman
...
{ 
    ...
    // Kedua fungsi ini memiliki nilai kembali (return value) berupa JSON diberikan oleh endpoint webservice Raja Ongkir, namun hanya mengambil bagian “data” 
    $body = json_decode($response->getBody(), true); 
    return $this->response->setJSON($body['data']);
}

// berisi logic untuk melakukan insert data transaksi ke database. 
public function buy()
{
